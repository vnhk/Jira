...
public class DisplayUserFormAction implements Action {
    private SessionService session;
    private DisplayFormView displayFormView;
    private InfoService info;
    private AccessService accessService;

    public DisplayUserFormAction(SessionService session, DisplayFormView displayFormView, InfoService info, AccessService accessService) {
    ...
    public void execute() {
        try {
            ...
            displayFormView.display("/userForm.jsp");
